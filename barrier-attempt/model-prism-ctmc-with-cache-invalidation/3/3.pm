...
const int empty = 0;
const int full  = me_bit_1 + me_bit_2 + me_bit_3 + 0;
...
module process_1
	...
	[set_entry_1_23] l_1=1 & mesi_1!=modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=1-me_bit_1 -> write : (l_1'=2) & (entry_1'=1) & (cp_1'=1) & (mesi_1'=modified);
	[set_entry_1_23] l_1=1 & mesi_1 =modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=1-me_bit_1 -> tick  : (l_1'=2) & (entry_1'=1) & (cp_1'=1);
	[set_entry_2_23] l_1=1 & mesi_1!=modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=2-me_bit_1 -> write : (l_1'=2) & (entry_1'=2) & (cp_1'=2) & (mesi_1'=modified);
	[set_entry_2_23] l_1=1 & mesi_1 =modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=2-me_bit_1 -> tick  : (l_1'=2) & (entry_1'=2) & (cp_1'=2);
	[set_entry_3_23] l_1=1 & mesi_1!=modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=3-me_bit_1 -> write : (l_1'=2) & (entry_1'=3) & (cp_1'=3) & (mesi_1'=modified);
	[set_entry_3_23] l_1=1 & mesi_1 =modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=3-me_bit_1 -> tick  : (l_1'=2) & (entry_1'=3) & (cp_1'=3);
	[set_entry_4_23] l_1=1 & mesi_1!=modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=4-me_bit_1 -> write : (l_1'=2) & (entry_1'=4) & (cp_1'=4) & (mesi_1'=modified);
	[set_entry_4_23] l_1=1 & mesi_1 =modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=4-me_bit_1 -> tick  : (l_1'=2) & (entry_1'=4) & (cp_1'=4);
	[set_entry_5_23] l_1=1 & mesi_1!=modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=5-me_bit_1 -> write : (l_1'=2) & (entry_1'=5) & (cp_1'=5) & (mesi_1'=modified);
	[set_entry_5_23] l_1=1 & mesi_1 =modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=5-me_bit_1 -> tick  : (l_1'=2) & (entry_1'=5) & (cp_1'=5);
	[set_entry_6_23] l_1=1 & mesi_1!=modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=6-me_bit_1 -> write : (l_1'=2) & (entry_1'=6) & (cp_1'=6) & (mesi_1'=modified);
	[set_entry_6_23] l_1=1 & mesi_1 =modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=6-me_bit_1 -> tick  : (l_1'=2) & (entry_1'=6) & (cp_1'=6);
	[set_entry_7_23] l_1=1 & mesi_1!=modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=7-me_bit_1 -> write : (l_1'=2) & (entry_1'=7) & (cp_1'=7) & (mesi_1'=modified);
	[set_entry_7_23] l_1=1 & mesi_1 =modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=7-me_bit_1 -> tick  : (l_1'=2) & (entry_1'=7) & (cp_1'=7);
	...
	[set_exit_1_23] l_1=7 & mesi_1!=modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=1-me_bit_1 -> write : (l_1'=8) & (exit_1'=1) & (cp_1'=1) & (mesi_1'=modified);
	[set_exit_1_23] l_1=7 & mesi_1 =modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=1-me_bit_1 -> tick  : (l_1'=8) & (exit_1'=1) & (cp_1'=1);
	[set_exit_2_23] l_1=7 & mesi_1!=modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=2-me_bit_1 -> write : (l_1'=8) & (exit_1'=2) & (cp_1'=2) & (mesi_1'=modified);
	[set_exit_2_23] l_1=7 & mesi_1 =modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=2-me_bit_1 -> tick  : (l_1'=8) & (exit_1'=2) & (cp_1'=2);
	[set_exit_3_23] l_1=7 & mesi_1!=modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=3-me_bit_1 -> write : (l_1'=8) & (exit_1'=3) & (cp_1'=3) & (mesi_1'=modified);
	[set_exit_3_23] l_1=7 & mesi_1 =modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=3-me_bit_1 -> tick  : (l_1'=8) & (exit_1'=3) & (cp_1'=3);
	[set_exit_4_23] l_1=7 & mesi_1!=modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=4-me_bit_1 -> write : (l_1'=8) & (exit_1'=4) & (cp_1'=4) & (mesi_1'=modified);
	[set_exit_4_23] l_1=7 & mesi_1 =modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=4-me_bit_1 -> tick  : (l_1'=8) & (exit_1'=4) & (cp_1'=4);
	[set_exit_5_23] l_1=7 & mesi_1!=modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=5-me_bit_1 -> write : (l_1'=8) & (exit_1'=5) & (cp_1'=5) & (mesi_1'=modified);
	[set_exit_5_23] l_1=7 & mesi_1 =modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=5-me_bit_1 -> tick  : (l_1'=8) & (exit_1'=5) & (cp_1'=5);
	[set_exit_6_23] l_1=7 & mesi_1!=modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=6-me_bit_1 -> write : (l_1'=8) & (exit_1'=6) & (cp_1'=6) & (mesi_1'=modified);
	[set_exit_6_23] l_1=7 & mesi_1 =modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=6-me_bit_1 -> tick  : (l_1'=8) & (exit_1'=6) & (cp_1'=6);
	[set_exit_7_23] l_1=7 & mesi_1!=modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=7-me_bit_1 -> write : (l_1'=8) & (exit_1'=7) & (cp_1'=7) & (mesi_1'=modified);
	[set_exit_7_23] l_1=7 & mesi_1 =modified & mod(floor(cp_1/me_bit_1),2)=0 & cp_1=7-me_bit_1 -> tick  : (l_1'=8) & (exit_1'=7) & (cp_1'=7);
	...
	[set_entry_0_12]     true -> (entry_1'=0)     & (mesi_1'=invalid);
	[set_entry_0_13]     true -> (entry_1'=0)     & (mesi_1'=invalid);
	...
	[set_entry_7_12]     true -> (entry_1'=7)     & (mesi_1'=invalid);
	[set_entry_7_13]     true -> (entry_1'=7)     & (mesi_1'=invalid);

	[set_exit_0_12]      true -> (exit_1'=0)      & (mesi_1'=invalid);
	[set_exit_0_13]      true -> (exit_1'=0)      & (mesi_1'=invalid);
	...
	[set_exit_7_12]      true -> (exit_1'=7)      & (mesi_1'=invalid);
	[set_exit_7_13]      true -> (exit_1'=7)      & (mesi_1'=invalid);
endmodule
...
module process_3 = process_1 [
	...
	write_1           =write_3,
	write_3           =write_1,
	set_left_false_12 =set_left_false_23,
	set_left_false_13 =set_left_false_13,
	set_left_false_23 =set_left_false_12,
	set_left_true_12  =set_left_true_23,
	set_left_true_13  =set_left_true_13,
