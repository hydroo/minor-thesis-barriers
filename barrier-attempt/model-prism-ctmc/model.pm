...
module process_1
	...
	[] l_1=5 & mod(floor(cp_1/me_bit_1),2)=1 -> tick : (l_1'=6);
	[] l_1=5 & mod(floor(cp_1/me_bit_1),2)=0 -> write : (l_1'=6) & (exit'=min(max_invalid,max(cp_1+me_bit_1, min_invalid)));

	[] l_1=6 & (  cp_1 != full & left = true ) -> tick : (l_1'=4);
