...
\end{itemize}
In this section we first present a new variant of a barrier protocol of ours. The second algorithm reverses the core of the central counter barrier. Third we demonstrate a pW/CS-influenced variant of the second barrier.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{MGB Barrier}
\label{ssec:new-mgb}
\begin{itemize}
	\item original idea by Nicholas Mc Guire was given to me in a private communique.
	\item modification of the original protocol resulted in Figure~\ref{fig:pseudocode-mgb}
	\item first appearance in \cite{bre13}. Slight modification since then "remembers others" considered here. Don't explain in detail what the modification is and does, since the reader has no knowledge of the previous version and I don't want to explain all of it.
		\begin{figure}[htbp]
			\centering
			\input{listings/mgb}
			\caption{Pseudocode of MGB Barrier}
