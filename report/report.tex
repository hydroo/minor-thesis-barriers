...
\begin{itemize}
	\item interesting values to query for
		\begin{itemize}
			\item time: unit: cycles. srew 1.
			\item energy consumption: unit: Joule, and rate of energy consumption : Joule per second = Watt. (assume 2.5ghz. W (nJ/ns) = 2.5 * nJ/cycle)
				\begin{itemize}
