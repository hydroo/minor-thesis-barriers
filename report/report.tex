...
Resource contention is another detail we do not model in this work. Our theoretical computer concurrently transfer data between processes with arbitrarily high bandwidth.
