...
\begin{itemize}
	...
	\item Spin\cite{spin, hol97} (already cites before) for model checking functional properties
	\item PRISM\cite{prism, knp09} (already cited before) for quantitative analysis
