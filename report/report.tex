...
\begin{itemize}
	...
	\item motivation for researching barriers: apply ideas of pwcs\cite{pwcs} to other synchronization primitives, e.g. barriers, and model check them\cite{bai13}. (reread both. Maybe his intentions are different from ours. Point that out. ?Speed vs Safety, probabilistic correctness vs probabilistic runtime?)
		\begin{itemize}
