...
\begin{itemize}
    ...
    % $ sudo ./rapl-benchmark 4 3 --ghz 2.5 --add-fetch-barrier 2 3 4 --add-fetch-wait-spinning 2 3 4 --add-fetch-contested 2 3 4 --add-fetch-uncontested 2 3 4 --super-wasteful-2 2 3 4 --super-wasteful-5 2 3 4 --dissemination 2 3 4
    % # measureSleepPowerConsumption:
    % # measurement t   1 wallSecs 3.000, totalPower 4.339 W
    % # measureUncorePowerConsumption:
    % # measurement t   1 wallSecs 3.909, totalPower 19.215 W
    % # measurement t   2 wallSecs 4.378, totalPower 19.394 W
    % # measurement t   3 wallSecs 4.601, totalPower 27.642 W
    % # measurement t   4 wallSecs 4.715, totalPower 27.855 W
    % add-fetch-barrier     t   2, reps  102531000, wallSecs 3.542 sec, totalPower 18.045 W, cycles/reps 86.364, nJ/reps 623.372
    % add-fetch-barrier     t   3, reps   32001000, wallSecs 4.000 sec, totalPower 19.738 W, cycles/reps 312.493, nJ/reps 2467.180
    % add-fetch-barrier     t   4, reps   23430000, wallSecs 4.000 sec, totalPower 22.190 W, cycles/reps 426.791, nJ/reps 3788.256
    % add-fetch-wait-spin   t   1, wallSecs 3.003 sec, totalPower 16.258 W
    % add-fetch-wait-spin   t   2, wallSecs 3.000 sec, totalPower 22.073 W
    % add-fetch-wait-spin   t   3, wallSecs 3.000 sec, totalPower 22.320 W
    % add-fetch-contested   t   2, reps   98304000, wallSecs 4.492 sec, totalPower 13.937 W, cycles/reps 114.242, nJ/reps 636.898
    % add-fetch-contested   t   3, reps   73728000, wallSecs 3.580 sec, totalPower 15.607 W, cycles/reps 121.408, nJ/reps 757.904
    % add-fetch-contested   t   4, reps   49152000, wallSecs 4.805 sec, totalPower 15.783 W, cycles/reps 244.376, nJ/reps 1542.782
    % add-fetch-uncontested t   2, reps  184320000, wallSecs 3.241 sec, totalPower 15.130 W, cycles/reps 43.960, nJ/reps 266.042
    % add-fetch-uncontested t   3, reps  208896000, wallSecs 4.017 sec, totalPower 20.093 W, cycles/reps 48.079, nJ/reps 386.415
    % add-fetch-uncontested t   4, reps  208896000, wallSecs 4.024 sec, totalPower 20.119 W, cycles/reps 48.159, nJ/reps 387.554
    % super-wasteful-2      t   2, reps  211743000, wallSecs 3.832 sec, totalPower 19.056 W, cycles/reps 45.248, nJ/reps 344.903
    % super-wasteful-2      t   3, reps   63828000, wallSecs 4.000 sec, totalPower 24.727 W, cycles/reps 156.678, nJ/reps 1549.650
    % super-wasteful-2      t   4, reps   52749000, wallSecs 4.000 sec, totalPower 26.563 W, cycles/reps 189.586, nJ/reps 2014.360
    % super-wasteful-5      t   2, reps  292824000, wallSecs 3.999 sec, totalPower 19.894 W, cycles/reps 34.144, nJ/reps 271.712
    % super-wasteful-5      t   3, reps   98991000, wallSecs 4.000 sec, totalPower 26.625 W, cycles/reps 101.015, nJ/reps 1075.792
    % super-wasteful-5      t   4, reps   69321000, wallSecs 4.000 sec, totalPower 27.765 W, cycles/reps 144.257, nJ/reps 1602.133
    % dissemination         t   2, reps  106419000, wallSecs 4.000 sec, totalPower 19.790 W, cycles/reps 93.963, nJ/reps 743.823
    % dissemination         t   3, reps   33657000, wallSecs 4.000 sec, totalPower 25.820 W, cycles/reps 297.105, nJ/reps 3068.488
    % dissemination         t   4, reps   30573000, wallSecs 4.000 sec, totalPower 28.417 W, cycles/reps 327.081, nJ/reps 3717.831
    % # context t   4, sleepPower 4.338675 W, uncorePower 11.996751 W
\end{itemize}
