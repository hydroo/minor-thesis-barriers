...
Aside from implementing barriers in software vendors can wire barrier protocols into the system's hardware. This is almost never done on shared memory architectures. One example for hardware barrier support is the SGI\textregistered UV\texttrademark 2000~\cite{sgiuv2000}, a high-performance shared memory computer.
