...
\begin{itemize}
	...
	\item explain the basic listing style somewhere
		\begin{itemize}
			\item C-esque pseudo-code
			\item threadCount/processCount
			\item threadIndex/processIndex
			\item the code in the listings is executed on each thread. Each thread has an identifier between 0 and threadCount-1
