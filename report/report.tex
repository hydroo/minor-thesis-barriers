...
\begin{itemize}
	...
	\item rate of power consumption per phase: Figure~\ref{fig:df-power-work-100}
		...
		\begin{itemize}
			\item \todo
		\end{itemize}
	\item rate of power consumption dissemination only: Figure~\ref{fig:d-power-work-100}
		\begin{figure}[htbp]
			\centering
			\includegraphics[width=8cm]{charts/d-power-work-100}
			\caption{Power consumption rate per phase}
			\label{fig:d-power-work-100}
		\end{figure}
		\begin{itemize}
			\item \todo
		\end{itemize}
	\item work=1000
	\item distribution of total time spent: Figure~\ref{fig:df-work-1000-partition}
		\begin{figure}[htbp]
			\centering
			\includegraphics[width=10cm]{charts/df-time-work-1000-partition}
			\includegraphics[width=10cm]{charts/df-energy-work-1000-partition}
	...
	\item dissemination: distribution of total time spent: Figure~\ref{fig:d-work-1000-partition}
		\begin{figure}[htbp]
			\centering
			\includegraphics[width=10cm]{charts/d-time-work-1000-partition}
			\includegraphics[width=10cm]{charts/d-energy-work-1000-partition}
			\caption{Distribution of total time spent for the dissemination barrier}
	...
	\item rate of power consumption dissemination only: Figure~\ref{fig:d-power-work-1000}
		\begin{figure}[htbp]
			\centering
			\includegraphics[width=10cm]{charts/d-power-work-1000}
			\caption{Power consumption rate per phase}
