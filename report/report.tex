...
%%%%%%%%%%
\paragraph{Shared Memory Variable}
...
In this work we present three innovative barrier protocols. We compare two of them to two state-of-the-art protocols using model checking techniques. The B2 Barriers turns out to be a promising algorithm, in that it has a lower execution time and energy consumption than the Dissemination Barrier.
