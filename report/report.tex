...
\begin{itemize}
	...
	\item resulting properties
		...
		\end{itemize}
	\item \todo properties of dissemination and ronny's fancy
		\begin{itemize}
			\item progress
			...
			\begin{itemize}
				...
				\item percent Figure~\ref{fig:cs-work-1000-percent}
					...
					\begin{itemize}
						...
						\item ronny's simple waiting time increases linearly with the number of threads (2:77, 3:145, 4:208 cycles). Expectation is ~50 across all thread counts in reality and 50, 25+50, 16+25+50 for CTMC interleaving. !!!! \todo mistake !!!
					\end{itemize}
