...
\begin{itemize}
	...
	\item paths in a CTMC are sequences of consecutive transitions augmented by the time points when they are taken. The quantitative analysis using the logics CSL \cite{assb00, bhhk00} relies on the standard $\sigma$-algebra on infinite paths and probability measures (see e.g. \cite{kul95, ks76}).
