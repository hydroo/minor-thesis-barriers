...
\begin{itemize}
	...
	\item functional model implements reseting and repetition. Three barriers, as described in~\ref{ssec:building-blocks}. (if you did not describe it there you have to do it here)
\end{itemize}

%%%%%%%%%%
\paragraph{Ronny simple barrier}
